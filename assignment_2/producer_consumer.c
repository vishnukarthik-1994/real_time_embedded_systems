...
I have used 7 producers and 7 consumers to demonstrate the solution. You can always play with these values.
*/
...
{   
    ...
    int a[BufferSize] = {1,2,3,4,5}; //Just used for numbering the producer and consumer
